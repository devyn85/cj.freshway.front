...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'배송라벨삭제현황'} />

			<SearchFormResponsive form={form} initialValues={searchBox}>
				<li>
					<Datepicker label={'출고일자'} />
				</li>

				<li>
					<InputText label={'상품코드'} placeholder="거래처 입력" />
				</li>
				<li>
					<InputText label={'관리처코드'} placeholder="거래처 입력" />
				</li>
				<li>
					<InputText label={'주문번호'} placeholder="거래처 입력" />
				</li>
			</SearchFormResponsive>
