...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'외부비축BL내재고이관'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li>
					<Datepicker label={'조정일자'} />
				</li>
				<li>
					<InputSearch label={'귀속부시'} placeholder="귀속부시 검색" />
				</li>
				<li>
					<InputSearch label={'거래처'} placeholder="거래처 검색" />
				</li>
