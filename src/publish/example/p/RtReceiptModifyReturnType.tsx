...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'반품회수/미회수변경'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li>
					<InputSearch label={'반품구분'} placeholder="반품구분 검색" />
				</li>
				<li>
					<Rangepicker label={'일자'} />
				</li>
				<li>
					<InputSearch label={'고객반품주문번호'} placeholder="고객반품주문번호 검색" />
				</li>
				<li>
					<SelectBox label={'협력사반품'} />
				</li>
				<li>
					<SelectBox label={'회사여부'} />
				</li>
				<li>
				...
				<li>
					<SelectBox label={'주문사유'} />
				</li>
				<li>
					<SelectBox label={'반품유형'} />
				</li>
				<li>
