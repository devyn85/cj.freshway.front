...
// Component
import { InputSearch, InputText, Rangepicker, SearchFormResponsive, SelectBox } from '@/components/common/custom/form';
...
const StLocMoveAsrs = forwardRef((props: any, gridRef: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'자동창고보충'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li>
					<InputSearch label={'창고'} placeholder="상품코드 검색" />
				</li>
				<li>
				...
				<li>
					<InputText label={'이력번호'} placeholder="이력번호 입력" />
				</li>
				<li>
					<InputSearch label={'계약업체'} placeholder="주문번호 입력" />
				</li>
				<li>
					<InputText label={'FROM 로케이션'} placeholder="FROM 로케이션 입력" />
				</li>
				<li>
					<InputText label={'TO 로케이션'} placeholder="TO 로케이션 입력" />
				</li>
				<li style={{ gridColumn: '3 / span 2' }}>
					<span>
						<InputText label={'이동 로케이션'} placeholder="이력번호 입력" />
						<Button type="default" className="sp-mr-1">
							선택적용
						</Button>
						<Button type="default">고정로케이션적용</Button>
					</span>
				</li>
