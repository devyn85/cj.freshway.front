/*
 ############################################################################
 # FiledataField	: StTransaction.tsx
...
// lib
import { apiGetMasterList } from '@/api/st/apiStTransaction';
...
const StTransaction = () => {
	...
	const searchMasterList = async () => {
		...
		// trantype 필수입력 체크
		// if (!params.trantype || params.trantype === '') {
		// 	showAlert(null, t('msg.selectPlease1', [t('lbl.TRANTYPE')])); // {거래유형}을/를 선택해주세요
		// 	return;
		// }
