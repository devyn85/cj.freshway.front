...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'외부센터보충발주'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li>
					<InputSearch label={'상품코드'} placeholder="상품코드 입력" />
				</li>
				<li>
					<SelectBox label={'공급센터'} placeholder="공급센터 선택" />
				</li>
				<li>
					<InputSearch label={'창고'} placeholder="창고 검색" />
				</li>
				<li>
					<SelectBox label={'공급받는 센터'} placeholder="공급받는 선택" />
				</li>
				<li>
