...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'재고라벨출력'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li  style={{ gridColumn: '1 / span 4' }}>
					<span>
					<InputText label={'계체식별/유통이력'} placeholder="TO 로케이션 입력" />
						<span className="color-danger">	* 전상품 조회시 속도가 많이느려지며 서버에 많은 부담을 주게 됩니다.</span>
					</span>
			</li>
