...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'일배입고검수출력​'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li>
					<InputSearch label={'입고전표번호'} placeholder="상품코드 검색" />
				</li>
				<li>
				...
				<li>
					<InputSearch label={'상품코드'} placeholder="관리처코드 검색" />
				</li>
				<li>
					<SelectBox label={'구매유형'} />
				</li>
				<li>
					<SelectBox label={'저장조건'} />
				</li>
				<li>
					<SelectBox label={'저장유무'} />
				</li>
				<li>
					<SelectBox label={'배차변경여부'} />
				</li>
				<li>
					<SelectBox label={'출력유형'} />
				</li>
				...
				<Row gutter={12}>
					<Col span={12}>
						<AGrid>
							<GridTopBtn gridTitle={'PO정보'} gridBtn={gridBtn} totalCnt={120} />
							<AUIGrid columnLayout={getGridCol()} gridProps={getGridProps()} />
						</AGrid>
					</Col>
					<Col span={12}>
						<AGrid>
							<GridTopBtn gridTitle={'PO미맵핑 거래처'} gridBtn={gridBtn} totalCnt={120} />
							<AUIGrid columnLayout={getGridCol()} gridProps={getGridProps()} />
						</AGrid>
					</Col>
				</Row>
