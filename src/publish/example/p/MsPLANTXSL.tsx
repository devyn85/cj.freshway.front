...
const pageSample6 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'저장위치정보'} />

			<SearchFormResponsive form={form} initialValues={searchBox}>
				<li>
					<InputText label={'센터'} value="외부비축센터" readOnly />
				</li>
				<li>
					<InputSearch label={'저장위치'} placeholder="저장위치 검색" />
				</li>
				<li>
					<SelectBox label={'현재고여부'} placeholder="현재고여부 선택" />
				</li>
				<li>
