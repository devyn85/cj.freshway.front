...
const StInquiryResult = forwardRef((props: any, gridRef: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'재고조사현황'} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				...
				<li>
					<InputText label={'조사번호'} placeholder="조사번호 입력" />
				</li>
				<li>
