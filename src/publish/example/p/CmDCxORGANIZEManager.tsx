...
const CmDCxORGANIZEManager = forwardRef((props: any, gridRef: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<MenuTitle authority="searchYn|saveYn" name={'물류센터별창고관리'} />
			...
			<Row gutter={8}>
				<Col span={12}>
					<AGrid>
						<GridTopBtn gridTitle={'물류센터창고 목록'} gridBtn={getGridBtn()} totalCnt={props.totalCnt} />
							...
							<Col span={24}>
								<UiDetailViewArea>
									<UiDetailViewGroup className="grid-column-2" ref={groupRef}>
										...
										<li>
											<InputText label={'창고'} placeholder="창고 입력" />
										</li>
									</UiDetailViewGroup>
								</UiDetailViewArea>
							</Col>
