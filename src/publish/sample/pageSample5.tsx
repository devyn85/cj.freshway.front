...
// Lib
import { Button, Col, Form, Pagination, Row, Tabs } from 'antd';
...
const pageSample5 = forwardRef((props: any, gridRef: any) => {
	...
	return (
		<>
			...
			<AGrid>
				{/*dataProps={'row-single'} 검색창이 3줄확보 되었을때  dataProps={'row-pull'} 검색창이 1줄일때*/}
			...
			<Row className="sp-my-2 flex-align-just">
				...
				<Col span={8} className="flex-just-cen">
					<Pagination simple total={120} pageSize={4} showSizeChanger={false} />
				</Col>
