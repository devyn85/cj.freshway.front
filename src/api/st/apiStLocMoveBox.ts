/*
 ############################################################################
 # FiledataField	: apiStLocMoveBox.ts
 # Description		: 재고 > 재고현황 > 재고일괄이동(수원3층) 조회 API
 # Author			: sss
 # Since			: 2025.07.31
 ############################################################################
*/
...
const REQUEST_API = '/api/st/locMoveBox';

/**
 * 재고 > 재고현황 > 재고일괄이동(수원3층) - 변경이력Tab List
 * @param params
 * @returns {object}  목록
 */
...
/**
 * 재고 > 재고현황 > 재고일괄이동(수원3층)  - 상품이력번호변경Tab List
