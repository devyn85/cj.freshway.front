...
/**
 * 출고 > 출고작업 > 퀵접수(VSR)및처리 - 퀵물류센터 조회
 * @param {any} params  검색 조건
 * @returns {object}  목록
 */
const apiGetSelectQuickCenterList = (params: any) => {
	return axios.get(REQUEST_API + '/v1.0/selectQuickCenterList', { params }).then(res => res.data);
};

export {
	apiGetCenterList,
	apiGetSelectQuickCenterList,
