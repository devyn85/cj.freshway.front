...
const OmPurchaseInspectOutPop = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const gridProps = {
		...
		groupingFields: ['outOrganize'],
		// 합계(소계) 설정
		groupingSummary: {
			dataFields: ['finalPlt', 'pltTransCal', 'kgCalQty'],
		},
...
export default OmPurchaseInspectOutPop;
