...
const OmInplan = () => {
	...
	const searchMasterList = () => {
		...
		const params = {
			...searchParams,
			fromDeliveryDate: form.getFieldValue('rangeDocDt')[0]
				? form.getFieldValue('rangeDocDt')[0].format('YYYYMMDD')
				: '',
			toDeliveryDate: form.getFieldValue('rangeDocDt')[1] ? form.getFieldValue('rangeDocDt')[1].format('YYYYMMDD') : '',
	...
	return (
		<>
			...
			<OmInplanDetail ref={refs} data={gridData} totalCnt={totalCnt} />
		</>
	);
};
