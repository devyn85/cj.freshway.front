...
const OmOrderCreationSTOOrdBaseFO = () => {
	...
	return (
		<>
			...
			<AGrid>
				<Tabs defaultActiveKey="1" onChange={onTabChange} activeKey={currentTabKey} className="h100">
					<TabPane tab={t('이체대상')} key="1">
