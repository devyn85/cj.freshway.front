...
import SysAuthorityUserDetail from '@/components/sys/authority/SysAuthorityUserDetail';
import SysAuthorityUserSearch from '@/components/sys/authority/SysAuthorityUserSearch';

// API
import { apiGetSysAuthorityGroupList } from '@/api/sys/apiSysAuthority';

const SysAuthorityUser = () => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			...
			<SearchFormResponsive form={form}>
				<SysAuthorityUserSearch search={search} />
			</SearchFormResponsive>

			{/* 화면 상세 영역 정의 */}
			<SysAuthorityUserDetail ref={refs} data={gridData} totalCnt={totalCntGrp} callBackFn={search} form={form} />
		</>
	);
};

export default SysAuthorityUser;
