...
// util
import { apiPostMasterList } from '@/api/st/apiStTplReceiptReq';
//components
import StTplReceiptReqDetail from '@/components/st/tplReceiptReq/StTplReceiptReqDetail';
import StTplReceiptReqSearch from '@/components/st/tplReceiptReq/StTplReceiptReqSearch';
	...
	return (
		<>
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				<StTplReceiptReqSearch form={form} />
			</SearchFormResponsive>
			{/* 화면 상세 영역 정의 */}
			<StTplReceiptReqDetail ref={refs} data={gridData} totalCnt={totalCnt} fnCallBack={searchMaterList} form={form} />
		</>
	);
};

export default StTplReceiptReq;
