/*
 ############################################################################
 # FiledataField	: StLocMoveBox.tsx
 # Description		: 재고 > 재고현황 > 재고일괄이동(수원3층)
 # Author			: sss
 # Since			: 25.07.10
 ############################################################################
*/
...
//Util
import { apiPostTab1MasterList, apiPostTab2MasterList } from '@/api/st/apiStLocMoveBox';
import StLocMoveBoxDetail1 from '@/components/st/locMoveBox/StLocMoveBoxDetail1';
import StLocMoveBoxDetail2 from '@/components/st/locMoveBox/StLocMoveBoxDetail2';
import StLocMoveSearch from '@/components/st/locMoveBox/StLocMoveBoxSearch';
...
const StLocMoveBox = () => {
	...
	const [resizeTarget, setResizeTarget] = useState({ ref: refs.gridRef, searchConditonLiCnt: 3, moreHeight: 30 }); // 최초load시 조정
		...
		try {
			if (activeKeyMaster === '1') {
				...
				const params = {
					...
					contractCompany: commUtil.nvl(form.getFieldValue('contractcompany'), ''),
				};
