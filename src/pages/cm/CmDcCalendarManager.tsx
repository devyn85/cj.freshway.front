/*
 ############################################################################
 # FiledataField	: CmDcCalendarManager.tsx
 # Description		: 주문 > 주문목록 > 당일광역부충발주용 센터별휴일관리
...
// Component
import CmCalendarManagerDetail from '@/components/cm/dcCalendarManager/CmDcCalendarManagerDetail';
import CmCalendarManagerSearch from '@/components/cm/dcCalendarManager/CmDcCalendarManagerSearch';
import { SearchFormResponsive } from '@/components/common/custom/form';
import MenuTitle from '@/components/common/custom/MenuTitle';

// API
import { apiGetMasterList } from '@/api/cm/apiCmDcCalendarManager';
...
const CmCalendarManager = () => {
	...
	const [searchBox] = useState({
		...
		restDesc: '', // 휴일내용
		dccode: dccode, // 물류센터
		calendarId: 'TGSA', // 구분 ('1000센터'(1000) 또는 공통('STD' | 'FW00'))
	});
