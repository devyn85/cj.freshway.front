/*
 ############################################################################
 # FiledataField	: TmMultiDeliveryPoint.tsx
 # Description		: 다중납품처관리
...
// API Call Function
import { apiGetMasterList } from '@/api/tm/apiTmMultyDeliveryPoint';
import TmMultiDeliveryPointDetail from '@/components/tm/multiDeliveryPoint/TmMultyDeliveryPointDetail';
import TmMultiDeliveryPointSearch from '@/components/tm/multiDeliveryPoint/TmMultyDeliveryPointSearch';
import { showConfirmAsync } from '@/util/MessageUtil';
import dayjs from 'dayjs';

// Store

const TmMultiDeliveryPoint = () => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const [searchBox] = useState({
		basedtRange: [dayjs(), dayjs('29991231')],
		stdCustKey: '',
		partCustKey: '',
		stdCustKeyNm: '',
		partCustKeyNm: '',
	...
	return (
		<>
			...
			<SearchFormResponsive form={form} initialValues={searchBox} onValuesChange={onValuesChange}>
				<TmMultiDeliveryPointSearch form={form} />
			</SearchFormResponsive>

			{/* 화면 상세 영역 정의 */}
			<TmMultiDeliveryPointDetail
				ref={refs}
				data={gridData}
				totalCnt={totalCnt}
...
export default TmMultiDeliveryPoint;
