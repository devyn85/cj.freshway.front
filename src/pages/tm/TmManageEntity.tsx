...
//components
import TmManageEntityDetail from '@/components/tm/manageEntity/TmManageEntityDetail';
import TmManageEntitySearch from '@/components/tm/manageEntity/TmManageEntitySearch';
	...
	return (
		<>
			...
			<SearchFormResponsive form={form} initialValues={searchBox}>
				<TmManageEntitySearch form={form} />
			</SearchFormResponsive>
			{/* 화면 상세 영역 정의 */}
			<TmManageEntityDetail ref={refs} data={gridData} totalCnt={totalCnt} fnCallBack={searchMaterList} form={form} />
		</>
	);
};
