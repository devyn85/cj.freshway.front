export const polylineDecode = function (encodedPath: string, precision = 5): [number, number][] {
	...
	while (index < len) {
		// NOSONAR - Loop condition and increment variables are intentionally different
