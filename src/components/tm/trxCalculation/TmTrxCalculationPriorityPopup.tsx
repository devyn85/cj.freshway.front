/*
 ############################################################################
 # FiledataField	: TmTrxCalculationPriorityPopup.tsx
 # Description		: 운송비정산 - 차수별 착지 조회
...
// API Call Function
import { apiPosCostPriorityList } from '@/api/tm/apiTmTrxCalculation';
...
const TmTrxCalculationPriorityPopup = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const searchMasterList = () => {
		...
		apiPosCostPriorityList(params).then((res: any) => {
			if (gridRef.current) {
...
export default TmTrxCalculationPriorityPopup;
