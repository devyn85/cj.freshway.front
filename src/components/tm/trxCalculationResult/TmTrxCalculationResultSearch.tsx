/*
 ############################################################################
 # FiledataField	: TmTrxCalculationResultSearch.tsx
 # Description		: 운송비정산현황
...
interface TmTrxCalculationResultSearchProps {
	form: any;
}

const TmTrxCalculationResultSearch = (props: TmTrxCalculationResultSearchProps) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
...
export default TmTrxCalculationResultSearch;
