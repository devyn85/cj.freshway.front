...
const TmDispatchListCustomer = ({ data, totalCnt }: any) => {
	...
	const gridCol = [
		...
		{ headerText: '대표차량번호', dataField: 'carNo', width: 120 },
		...
		{ headerText: '주문 건 수', dataField: 'orderCnt', width: 100 },
	...
	return (
		<AGrid>
			<GridTopBtn gridTitle={'거래처별 배차목록'} gridBtn={gridBtn} totalCnt={totalCnt} />
