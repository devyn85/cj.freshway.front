/*
 ############################################################################
 # FiledataField	: TmWorklogByCustomerDetail.tsx
 # Description		: 배차작업로그(거래처별) 상세
...
// API Call Function
import { apiGetWorkLogByCustomerDetailList } from '@/api/tm/apiTmWorklogByCustomer';
...
interface TmWorklogByCustomerProps {
	form?: any;
	data: any;
	totalCnt: any;
	callBackFn: any;
}
const TmWorklogByCustomerDetail = forwardRef((props: TmWorklogByCustomerProps, ref: any) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const searchDetailList = (row: any) => {
		...
		apiGetWorkLogByCustomerDetailList(params).then(res => {
...
export default TmWorklogByCustomerDetail;
