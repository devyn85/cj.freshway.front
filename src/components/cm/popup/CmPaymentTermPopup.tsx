/*
 ############################################################################
 # FiledataField	: CmPaymentTermPopup .tsx
...
const CmPaymentTermPopup = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<PopupMenuTitle name="Payment Term 조회" func={titleFunc} />
...
export default CmPaymentTermPopup;
