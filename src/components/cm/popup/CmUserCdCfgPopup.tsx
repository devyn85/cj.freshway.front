...
const CmUserCdCfgPopup = (props: PropsType) => {
	...
	const gridCol = () => {
		...
		// 퀵 사용자 관리
			...
			return [
				{ headerText: t('lbl.SEQNO'), dataType: 'numeric', dataField: 'seqno', width: 80, required: true },
				{ headerText: t('센터코드'), dataField: 'basecode', required: true, width: 120, dataType: 'code' },
				...
				{ headerText: t('주소'), dataField: 'data3', required: true, dataType: 'string' },
				{ headerText: t('담당자'), dataField: 'data4', required: true, dataType: 'string' },
				{
					headerText: t('lbl.USE_YN'),
					dataField: 'useYn',
					required: true,
