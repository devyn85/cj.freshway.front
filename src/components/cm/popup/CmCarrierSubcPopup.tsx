/*
 ############################################################################
 # FiledataField	: CmCarrierSubcPopup.tsx
 # Description		: 2차 운송사 조회 팝업
 # Author			: KimSunHo
 # Since			: 25.05.09
...
const CmCarrierSubcPopup = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<PopupMenuTitle name="2차운송사조회" func={titleFunc} />
						...
						{carrierTypeHiddenYn === 'Y' ? (
							<li style={{ gridColumn: 'span 2' }}>
								<InputText
									name={name}
									label={'2차운송사코드/명'}
									placeholder={t('msg.placeholder2', ['2차운송사코드 또는 이름'])}
...
export default CmCarrierSubcPopup;
