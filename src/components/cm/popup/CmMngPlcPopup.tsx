/*
 ############################################################################
 # FiledataField	: CmMngPlcPopup.tsx
...
const CmMngPlcPopup = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<PopupMenuTitle name="관리처조회" func={titleFunc} />
			...
			<SearchFormResponsive form={form} initialValues={searchBox} groupClass="grid-column-2">
				<li>
					<InputText
						width={80}
						name={name}
						placeholder={t('msg.MSG_COM_VAL_006', ['관리처코드 또는 이름'])}
