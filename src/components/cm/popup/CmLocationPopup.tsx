/*
 ############################################################################
 # FiledataField	: CmLocationPopup.tsx
...
const CmLocationPopup = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const strPrefixNm = t('LOC_ST'); // 로케이션
	...
	return (
		<>
			{/* 상단 타이틀 및 페이지버튼 */}
			<PopupMenuTitle name={`${dccode ? 'KIT' : ''}${strPrefixNm}코드조회`} func={titleFunc} />
...
export default CmLocationPopup;
