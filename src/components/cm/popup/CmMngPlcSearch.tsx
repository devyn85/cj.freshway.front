/*
 ############################################################################
 # FiledataField	: CmMngPlcSearch.tsx
 # Description		: 관리처조회 팝업
...
// component
import CmMngPlcPopup from '@/components/cm/popup/CmMngPlcPopup';
import CustomModal from '@/components/common/custom/CustomModal';
import { InputSearch } from '@/components/common/custom/form';

// API Call Function
import { apiGetMngPlcPopupList } from '@/api/cm/apiCmSearch';
...
const CmMngPlcSearch = (props: SearchCustProps) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const getSearchApi = (isPopup: boolean, value: string) => {
		...
		apiGetMngPlcPopupList(params).then(res => {
			if (!isPopup) {
	...
	return (
		<>
			...
			>
				<InputSearch
					placeholder={t('msg.placeholder1', ['관리처코드 또는 이름'])}
					form={form}
					name={name}
					code={code}
					hidden={true}
					...
					label={label ?? t('lbl.TO_CUSTKEY_WD2')}
