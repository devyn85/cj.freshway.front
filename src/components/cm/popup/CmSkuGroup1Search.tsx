/*
 ############################################################################
 # FiledataField	: CmSkuGroup1Search.tsx
 # Description		: 소분류 조회 팝업
...
// component
import CmSkuGroup1Popup from '@/components/cm/popup/CmSkuGroup1Popup';
import CustomModal from '@/components/common/custom/CustomModal';
import { InputSearch } from '@/components/common/custom/form';

// API Call Function
import { apiGetSkuGroup1List } from '@/api/cm/apiCmSearch';
...
const CmSkuGroup1Search = (props: SearchCustProps) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const getSearchApi = (isPopup: boolean, value: string) => {
		...
		apiGetSkuGroup1List(params).then(res => {
			if (!isPopup) {
	...
	return (
		<>
			...
			>
				<InputSearch
					placeholder={t('msg.placeholder1', ['소분류코드 또는 이름'])}
					form={form}
					name={name}
					code={code}
					hidden={true}
...
export default CmSkuGroup1Search;
