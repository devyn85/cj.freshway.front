...
const CmCustRedZonePopup = (props: PropsType) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const onClickRefreshButton = () => {
		form.setFieldsValue({ [name]: '', multiSelect: '12' });
		setTotalCount(0);
	...
	return (
		<>
			...
			<PopupMenuTitle name={'특별관리 고객 조회'} func={titleFunc} />
...
export default CmCustRedZonePopup;
