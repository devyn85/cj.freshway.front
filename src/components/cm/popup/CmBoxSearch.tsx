...
// component
import CmBoxPopup from '@/components/cm/popup/CmBoxPopup';
import CommonPopupSearch from '@/components/common/search/CommonPopupSearch';

// API Call Function
import { apiGetBoxList } from '@/api/cm/apiCmSearch';
...
const CmBoxSearch = (props: SearchProps) => {
	...
	return (
		...
		<CommonPopupSearch
			...
			// 팝업파라미터 정의(3/3)
			extraParams={{
				dummy: props?.dummy, // dummy - BOX조회팝업은 현재 파라미터 없음
			}}
			modalWidth="1280px"
