/*
 ############################################################################
 # FiledataField	: CmPaymentTermSearch.tsx
 # Description		: PAYMENT TERM 조회 팝업
 # Author			: KimSunHo	
 # Since			: 25.08.09
 ############################################################################
*/
...
// component
import CmPaymentTermPopup from '@/components/cm/popup/CmPaymentTermPopup';
import CustomModal from '@/components/common/custom/CustomModal';
import { InputSearch } from '@/components/common/custom/form';

// API Call Function

import { apiGetPaymentTermList } from '@/api/cm/apiCmSearch';
...
const CmPaymentTermSearch = (props: SearchProps) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	 */
	const { form, selectionMode, name, code, returnValueFormat, value, label, isResetForm, required, disabled } = props;
	...
	const getSearchApi = (isPopup: boolean, value: string) => {
		...
		apiGetPaymentTermList(params).then(res => {
			if (!isPopup) {
...
export default CmPaymentTermSearch;
