...
const SearchSampleCarDriver = (props: any) => {
		...
		<>
			<UiFilterArea>
				<UiFilterGroup>
					...
					<li>
						<label data-required>차량번호</label>
						<span>
							<InputText
								name="carNo"
					...
					<li>
						<label>차량/POP 관리</label>
						<span>
							<CmCarPopSearch
								// ref={cmCarPopRef} // ⭐ 외부 ref 연결
								form={form}
								name="searchCarPopName"
								code="searchCarPopCode"
...
export default SearchSampleCarDriver;
