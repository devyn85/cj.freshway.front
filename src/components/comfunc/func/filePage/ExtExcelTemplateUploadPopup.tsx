...
//API Call Function
import { apiPostExcelTemplateSaveFile } from '@/api/sample/apiSample';
...
const ExtExcelTemplateUploadPopup = forwardRef((props: popupProps) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	function onClickSaveButton() {
		...
		apiPostExcelTemplateSaveFile(formDataParam).then(res => {
	...
	return (
		<SearchForm form={form}>
			<PopupMenuTitle name={'엑셀양식 파일업로드'} showButtons={false} showChildrens={true}>
				{/* 파일업로드, 저장, 삭제 */}
...
export default ExtExcelTemplateUploadPopup;
