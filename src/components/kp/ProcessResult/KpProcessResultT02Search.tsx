/*
 ############################################################################
 # FiledataField	: KpProcessResultT02Search.tsx
...
const KpProcessResultT02Search = forwardRef((props: any, parentRef: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<SearchFormResponsive form={form} initialValues={searchBox}>
			...
			<>
				<li>
					<InputText name="userId" label="ID" onPressEnter={search} />
				</li>
			</>
...
export default KpProcessResultT02Search;
