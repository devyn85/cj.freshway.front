/*
 ############################################################################
 # FiledataField	: KpProcessResultTab1Detail.tsx
...
const KpProcessResultTab1Detail = forwardRef((props: any, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			...
			<AGrid className="contain-wrap">
				...
				<AUIGrid ref={ref.gridRef} columnLayout={getGridCol1()} gridProps={gridProps} footerLayout={footerLayout} />
			</AGrid>
		</>
	);
});

export default KpProcessResultTab1Detail;
