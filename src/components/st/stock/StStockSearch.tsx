/*
 ############################################################################
 # FiledataField	: StStockSearch.tsx
 # Description		: 재고조회
 # Author			    : sss
 # Since			    : 25.07.04
 ############################################################################
...
const StStockSearch = (props: any) => {
	const { t } = useTranslation();
	const { form, fixdccode } = props;
		...
		<>
			...
			<li>
				<CmOrganizeSearch
					...
					dccode={Array.isArray(fixdccode) ? fixdccode[0] : fixdccode}
					label="창고"
					dccodeDisabled={true}
...
export default StStockSearch;

const EtcWrap = styled.li`
	grid-column: span 3;
