/*
 ############################################################################
 # FiledataField	: StAdjustmentRequestDetail1UploadExcelPopup.tsx
...
interface StAdjustmentRequestDetail1UploadExcelPopupProps {
	close?: any;
}

const StAdjustmentRequestDetail1UploadExcelPopup = forwardRef(
	(props: StAdjustmentRequestDetail1UploadExcelPopupProps, ref: any) => {
		/**
		 * =====================================================================
		 *	01. 변수 선언부
		 * =====================================================================
		...
		const verificationCallback = async () => {
			...
			excelData.forEach((item: any) => {
				...
				if (commUtil.isEmpty(item.processmain)) {
					// 물류귀책배부
					arrVerMsg.push(t('msg.placeholder1', [t('lbl.OTHER05_DMD_AJ')]));
				}
...
export default StAdjustmentRequestDetail1UploadExcelPopup;
