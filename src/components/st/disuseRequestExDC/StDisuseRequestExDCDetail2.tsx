/*
 ############################################################################
 # FiledataField	: StDisuseRequestExDCDetail2.tsx
 # Description		: 재고 > 재고조정 > 외부비축재고폐기처리 (폐기 요청 결과)
 # Author					: JiHoPark
 # Since					: 2025.08.25.
 ############################################################################
*/
...
interface StDisuseRequestExDCDetail2Props {
	data: any;
	totalCnt: any;
	form: any;
}

const StDisuseRequestExDCDetail2 = forwardRef((props: StDisuseRequestExDCDetail2Props, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol = [
		...
		{
			headerText: t('lbl.STOCKGRADENAME'),
			/*재고속성명*/ dataField: 'stockgradename',
			dataType: 'string',
			editable: false,
			width: 100,
		},
...
export default StDisuseRequestExDCDetail2;
