/*
 ...
 # Description		: 재고 > 재고조정 > 외부비축재고폐기처리 (조회)
 # Author					: JiHoPark
 # Since					: 2025.12.23.
 ############################################################################
*/
...
interface StDisuseRequeStExDCSearchProps {
	form: any;
	currentTabKey: string;
}

const StDisuseRequeStExDCSearch = (props: StDisuseRequeStExDCSearchProps) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
		...
		<>
			...
			{currentTabKey === '3' && (
				<>
					<li>
						<Rangepicker
							label={dateCondType === 'APPRREQDT' ? t('lbl.DISUSE_REQ_DATE') : t('lbl.DISUSE_DATE')}
...
export default StDisuseRequeStExDCSearch;
