/*
 ############################################################################
 # FiledataField	: StDisuseRequestExDCDetail1UploadExcelPopup.tsx
 # Description		:  재고 > 재고조정 > 외부비축재고폐기처리 (폐기 요청 목록) 엑셀 팝업
 # Author			: JiHoPark
 # Since			: 25.09.09
 ############################################################################
*/
...
interface StDisuseRequestExDCDetail1UploadExcelPopupType {
	close?: any;
}

const StDisuseRequestExDCDetail1UploadExcelPopup = forwardRef(
	(props: StDisuseRequestExDCDetail1UploadExcelPopupType, ref: any) => {
		/**
		 * =====================================================================
		 *	01. 변수 선언부
		 * =====================================================================
		...
		return (
			<>
				{/* 상단 타이틀 및 페이지버튼 */}
				<PopupMenuTitle name={t('lbl.EXCEL_UPLOAD_DISUSE')} showButtons={false} />
...
export default StDisuseRequestExDCDetail1UploadExcelPopup;
