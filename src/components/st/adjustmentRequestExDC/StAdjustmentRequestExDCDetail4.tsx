/*
 ############################################################################
 # FiledataField	: StAdjustmentRequestExDCDetail4.tsx
 # Description		: 재고 > 재고조정 > 외부비축재고조정처리 (재고 조정 처리)
 # Author					: JiHoPark
 # Since					: 2025.08.25.
 ############################################################################
*/
...
interface StAdjustmentRequestExDCDetail4Props {
	data: any;
	totalCnt: any;
	form: any;
	fixdccode: string;
...
const StAdjustmentRequestExDCDetail4 = forwardRef((props: StAdjustmentRequestExDCDetail4Props, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const confirmCallback = () => {
		...
		showConfirm(null, t('msg.MSG_COM_CFM_022'), () => {
			// loop transaction
			const saveParams = {
				apiUrl: '/api/st/adjustmentreqeustexdc/v1.0/saveMasterList4',
	...
	const gridBtn: GridBtnPropsType = {
		...
		btnArr: [
			/* 20251220 행삭제 기능 삭제 요청에 따른 기능 삭제
			{
				btnType: 'delete', // 행삭제
			},
			*/
...
export default StAdjustmentRequestExDCDetail4;
