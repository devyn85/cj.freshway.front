/*
 ############################################################################
 # FiledataField	: StAdjustmentRequestExDCDetail2.tsx
 # Description		: 재고 > 재고조정 > 외부비축재고조정처리 (재고 조정 요청 결과)
 # Author					: JiHoPark
 # Since					: 2025.08.25.
 ############################################################################
*/
...
interface StAdjustmentRequestExDCDetail2Props {
	data: any;
	totalCnt: any;
	form: any;
}

const StAdjustmentRequestExDCDetail2 = forwardRef((props: StAdjustmentRequestExDCDetail2Props, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
...
export default StAdjustmentRequestExDCDetail2;
