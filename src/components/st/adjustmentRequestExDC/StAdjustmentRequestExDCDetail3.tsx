/*
 ############################################################################
 # FiledataField	: StAdjustmentRequestExDCDetail3.tsx
 # Description		: 재고 > 재고조정 > 외부비축재고조정처리 (재고 조정 결재)
 # Author					: JiHoPark
 # Since					: 2025.08.25.
 ############################################################################
*/
...
interface StAdjustmentRequestExDCDetail3Props {
	data: any;
	totalCnt: any;
	form: any;
	searchHandler: any;
...
const StAdjustmentRequestExDCDetail3 = forwardRef((props: StAdjustmentRequestExDCDetail3Props, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol = [
		...
		{ headerText: t('lbl.REASON'), /*사유*/ dataField: 'stockamtmsg', dataType: 'string', width: 170 },
		{
	...
	return (
		<>
			...
			<AGrid style={{ marginTop: '15px' }}>
				...
				<GridAutoHeight id="inventory-adjustment-approval-grid">
...
export default StAdjustmentRequestExDCDetail3;
