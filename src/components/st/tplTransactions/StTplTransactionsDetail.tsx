/*
  ############################################################################
 # FiledataField	: StTplTransactionsDetail.tsx
...
const StTplTransactionsDetail = forwardRef((props: any, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol = [
		...
		{ dataField: 'serialNo', headerText: t('lbl.SERIALNO'), dataType: 'string', width: 180 },
		{ dataField: 'convSerialNo', headerText: t('lbl.BLNO'), dataType: 'string', width: 120 },
...
export default StTplTransactionsDetail;
