/*
 ############################################################################
 # FiledataField	: DpReceiptExDCDetailConfirm.tsx
...
interface DpReceiptExDCDetailConfirmProps {
	gridData: any;
	searchForm: any;
	callBackFn: any;
}

const DpReceiptExDCDetailConfirm = forwardRef((props: DpReceiptExDCDetailConfirmProps, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	return (
		<>
			...
			<Form form={form}>
				{/* 그리드 영역 정의 */}
				<AGrid>
					<GridTopBtn gridTitle={''} gridBtn={getGridBtn2()}>
						<SelectBox //결품사유
							name="reasonCodeConfirm"
...
export default DpReceiptExDCDetailConfirm;
