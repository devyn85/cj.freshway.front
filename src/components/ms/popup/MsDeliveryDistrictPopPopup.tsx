...
const MsDeliveryDistrictPopPopup = ({
  form,
  ...
  */
  ...
  const gridCol = [
    { headerText: '물류센터', dataField: 'dccode', minWidth: 100 },
    { headerText: '대표 POP 번호', dataType: 'string', dataField: 'popNo', minWidth: 100 },
    { headerText: '대표 POP 명', dataType: 'string', dataField: 'popName', minWidth: 100 },
    ...
    { headerText: '기본 대표 POP', dataType: 'string', dataField: 'baseYn', minWidth: 100 },
  ];
  ...
  return (
    <>
      <PopupMenuTitle name="대표 POP 조회" func={titleFunc} />
          ...
          <UiFilterGroup className="grid-column-2">
            ...
            <li>
							<InputText
								...
								placeholder={t('msg.placeholder2', ['대표 PoP 번호 또는 대표 POP 명'])}
...
export default MsDeliveryDistrictPopPopup;