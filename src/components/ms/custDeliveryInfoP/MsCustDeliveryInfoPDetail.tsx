...
import MsCustDeliveryInfoPUploadExcelPopup from '@/components/ms/custDeliveryInfoP/MsCustDeliveryInfoPUploadExcelPopup';
...
const MsCustDeliveryInfoPDetail = forwardRef((props: MsCustDeliveryInfoPDetailProps, gridRef: any) => {
	...
	// * 추가정보 테이블 아코디언 요소
	const addGridAccItems: AccordionItem[] = useMemo(
		() => [
			{
				key: 'add-grid-panel',
				children: (
	...
	// * 조달정보 그리드 아코디언 요소
	const procurementAccItems: AccordionItem[] = useMemo(
		() => [
			{
