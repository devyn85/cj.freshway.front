/*
 ############################################################################
 # FiledataField	: WdTaskTap4Detail.tsx
 # Description		: 피킹작업지시-조회생성(차량) Detail
 # Author			: 공두경
 # Since			: 25.09.18
 ############################################################################
*/
...
// Utils
// API Call Function
import { apiGetTab1DetailList, apiSavePickingBatch } from '@/api/wd/apiWdTask';
import GridAutoHeight from '@/components/common/GridAutoHeight';
import Splitter from '@/components/common/Splitter';

const WdTaskTap4Detail = forwardRef((props: any, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol2 = [
		{
			...
			headerText: t('lbl.DELIVERYGROUP_WD'),
			dataType: 'code',
		},
		{
			dataField: 'toCustkey',
		...
		{
			dataField: 'omsCloseYn',
			headerText: t('lbl.OMS_CLOSE_YN'),
			dataType: 'code',
		},
		{
			dataField: 'omsFlag',
			headerText: t('lbl.OMS_NONCLOSE_QTY'),
			dataType: 'code',
		},
		{
...
export default WdTaskTap4Detail;
