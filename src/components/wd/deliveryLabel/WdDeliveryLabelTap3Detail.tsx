/*
 ############################################################################
 # FiledataField	: WdDeliveryLabelTap3Detail.tsx
 # Description		: 출고 > 출고작업 > 배송라벨출력 - 기준정보
 # Author			: 공두경
 # Since			: 2025.11.17
 ############################################################################
*/
...
const WdDeliveryLabelTap3Detail = ({ gridData1, gridRef1, form, searchMasterList }: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol1 = [
		...
		},
		{
			...
			editRenderer: {
				...
				list: getCommonCodeList('PRINTORDER4', t('lbl.SELECT'), ''),
				keyField: 'comCd',
				valueField: 'cdNm',
			},
			labelFunction: (rowIndex: any, columnIndex: any, value: any) => {
				const name = getCommonCodebyCd('PRINTORDER4', value)?.cdNm;
...
export default WdDeliveryLabelTap3Detail;
