/*
 ############################################################################
 # FiledataField	: WdKxDeliveryInvoiceDetail4.tsx
 # Description		: 출고 > 출고작업 > 택배송장발행(온라인) (반품택배 탭) - 현재미사용
 # Author					: 
 # Since					: 2025.12.22.
 ############################################################################
*/
...
interface WdKxDeliveryInvoiceDetail4Props {
	data: any;
	totalCnt: any;
	form: any;
}

const WdKxDeliveryInvoiceDetail4 = forwardRef((props: WdKxDeliveryInvoiceDetail4Props, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
...
export default WdKxDeliveryInvoiceDetail4;
