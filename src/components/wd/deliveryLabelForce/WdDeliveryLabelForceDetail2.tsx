/*
 ############################################################################
 # FiledataField	: WdDeliveryLabelForceDetail2.tsx
 # Description		: 출고 > 출고 > 배송 라벨 출력(예외 기준 적용)_기준정보_탭 Grid
 # Author			: KimDongHan
 # Since			: 2025.10.17
 ############################################################################
*/
...
const WdDeliveryLabelForceDetail2 = ({ gridData1, gridRef1, form, searchMasterList }: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol1 = [
		...
		},
		{
			...
			editRenderer: {
				...
				list: getCommonCodeList('PRINTORDER2', t('lbl.SELECT'), ''),
				keyField: 'comCd',
				valueField: 'cdNm',
			},
			labelFunction: (rowIndex: any, columnIndex: any, value: any) => {
				const name = getCommonCodebyCd('PRINTORDER2', value)?.cdNm;
...
export default WdDeliveryLabelForceDetail2;
