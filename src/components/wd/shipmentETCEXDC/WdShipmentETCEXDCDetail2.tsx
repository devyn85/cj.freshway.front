/*
 ############################################################################
 # FiledataField	: WdShipmentETCEXDCDetail2.tsx
 # Description		: 출고 > 기타출고 > 외부센터매각출고처리 (기타출고 요청 결과)
 # Author					: JiHoPark
 # Since					: 2025.09.11.
 ############################################################################
*/
...
interface WdShipmentETCEXDCDetail2Props {
	data: any;
	totalCnt: any;
	form: any;
}

const WdShipmentETCEXDCDetail2 = forwardRef((props: WdShipmentETCEXDCDetail2Props, ref: any) => {
	/**
	 * =====================================================================
	 *  01. 변수 선언부
	 * =====================================================================
	...
	const gridCol = [
		...
		},
		{
			...
			/*처리유형*/ dataField: 'potypename',
			dataType: 'string',
			width: 160,
		},
		{
			headerText: t('lbl.PROCESSREASON_ETC'),
			/*처리사유*/ dataField: 'reasoncodename',
			dataType: 'string',
			width: 160,
		},
		{
	...
	return (
		<>
			...
			<GridAutoHeight id="request-processing-result-grid">
...
export default WdShipmentETCEXDCDetail2;
