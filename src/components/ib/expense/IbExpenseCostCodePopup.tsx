/*
 ############################################################################
 # FiledataField	: IbExpenseCostCodePopup.tsx
 # Description		: 비용기표 - 코스트코드 팝업
...
// API Call Function
import { apiPostCostCodeList } from '@/api/ib/apiIbExpense';
...
const IbExpenseCostCodePopup = forwardRef((_, ref) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	const gridCol = [
		...
		{
			// Name
			headerText: 'Cost Name',
			dataField: 'name',
		},
		{
			// ccount Cd
			headerText: 'Account Cd',
			dataField: 'data1',
			dataType: 'code',
		},
		{
	...
	const searchMasterList = () => {
		...
		// 조회 조건 설정
		const params = {};
		apiPostCostCodeList(params).then((res: any) => {
	...
	return (
		<CustomModal ref={modalRef} width="1000px">
			{/* 상단 타이틀 및 페이지버튼 */}
			<PopupMenuTitle name="코스트코드조회" func={titleFunc} />
...
export default IbExpenseCostCodePopup;
