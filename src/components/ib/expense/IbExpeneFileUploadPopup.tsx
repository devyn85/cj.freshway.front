/*
 ############################################################################
 # FiledataField	: IbExpeneFileUploadPopup.tsx
...
//API Call Function
import { apiPostDownloadFile, apiPostFileList, apiPostSaveFileUpload } from '@/api/ib/apiIbExpense';
...
const IbExpeneFileUploadPopup = forwardRef((props: popupProps) => {
	/**
	 * =====================================================================
	 *	01. 변수 선언부
	 * =====================================================================
	...
	function onClickSaveButton() {
		...
		formDataParam.append('serialkey', props.serialkey);
			...
			<AGrid>
				<div className="flex-wrap">
					...
					<div className="preview">
						{previewImage != '' ? <img className="" src={previewImage} /> : <span>이미지만 미리보기가 가능합니다</span>}
					</div>
					*/}
				</div>
			</AGrid>
...
export default IbExpeneFileUploadPopup;
